...
import { ResidenciaService, IListagemResidencia } from "@/app/shared/services/api/residencia/ResidenciaService";
...
export const ListagemDeResidencias: React.FC = () => {
    const [searchParams, setSearchParams] = useSearchParams();
    const { debounce } = useDebounce();
    const navigate = useNavigate();

    const [rows, setRows] = useState<IListagemResidencia[]>([]);
    ...
    return (
        <LayoutBaseDePagina
            titulo='Listagem das Residencia'
            barraDeFerramentas={
                <FerramentasDaListagem
                    mostrarInputBusca
                    textoDaBusca={busca}
                    textoBotaoNovo='Novo'
                    aoClicarEmNovo={() => navigate('/residencia/detalhe/novo')}
                        ...
                        {rows.map(residencia => (
                            ...
                            >
                                ...
                                <TableCell align="right">
                                    ...
                                    <IconButton
                                        onClick={() => navigate(`/residencia/detalhe/${residencia.id}`)}
                                    >
